    ...
    public class Parser
    {
        ...
        static public void Main(string[] args)
        {
            ...
            if (!ok)
            {
                ...
                Console.WriteLine("usage: Parser [-rule rulename] [-trace] <-file file | -string string> [-visitor visitor]");
            }
            else
            {
                try
                {
                    ...
                    if (arguments.ContainsKey("Visitor"))
                    {
                        ...
                        {
                            Visitor visitor = (Visitor)Activator.CreateInstance(type);
