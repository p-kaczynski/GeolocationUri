...
{
    sealed public class Rule_labeltext:Rule
    {
        private Rule_labeltext(string spelling, List<Rule> rules) :
            base(spelling, rules)
        {
        }
        ...
        public static Rule_labeltext Parse(ParserContext context)
        {
            ...
            if (parsed)
            {
                rule = new Rule_labeltext(context.text.Substring(a0.start, a0.end - a0.start), a0.rules);
            }
            else
            {
                context.index = s0;
            ...
            context.Pop("labeltext", parsed);

            return (Rule_labeltext)rule;
        }
    }
}
